        ...
        <div className="container">
            ...
            <div className="" id="websidebar" style={{
                ...
                <div className="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <Link className="nav-link active" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="true">Profile</Link>
                    <Link className="nav-link" id="v-pills-NGOs-tab" data-bs-toggle="pill" data-bs-target="#v-pills-NGOs" type="button" role="tab" aria-controls="v-pills-NGOs" aria-selected="false">NGOs</Link>
                    <Link className="nav-link" id="v-pills-blogs-tab" data-bs-toggle="pill" data-bs-target="#v-pills-blogs" type="button" role="tab" aria-controls="v-pills-blogs" aria-selected="false">Blogs</Link>
                    <Link className="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">Settings</Link>


                    {/* <Link to="/" className="nav-link" id="v-pills-back-tab" >Back</Link> */}
                    <button className="nav-link" id="v-pills-back-tab" onClick={togglesidebar}>hide</button>
            ...
            <div className="container" id="mainbody" style={{
                ...
                <div className="tab-content" id="v-pills-tabContent">
                    ...
                    <div className="tab-pane fade" id="v-pills-NGOs" role="tabpanel" aria-labelledby="v-pills-NGOs-tab">hello to the ngos</div>
