                        ...
                        <div className="row">
                            ...
                            {recentblogs.map((element,idx) => {
                                ...
                                return <div className="col " style={{ display: "flex", justifyContent: "center", margin: "0px", padding: "0px" }} key={idx}>
                                    <Blogcard name={element.name} linktourl={"http://localhost:3000/blogs/" + element._id} title={element.title} desc={element.about} baseimgurl={element.blogPictures.length > 0 ? element.blogPictures[0].img : "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?q=80&w=2873&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} mode={props.mode} Togglemode={props.Togglemode}></Blogcard>
                                </div>
